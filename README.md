...
For the frontend, create a file called .env.local in the [paggo-monorepo/apps/web](https://github.com/madeira-dev/paggo-ocr-case/paggo-monorepo/apps/web) directory.
